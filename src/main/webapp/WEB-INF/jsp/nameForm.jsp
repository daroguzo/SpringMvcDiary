    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-9 mx-auto">
                ...
                <c:if test="${sessionScope.id != null}">
                    <h1 class="mb-5">${sessionScope.id}님의 이름 변경</h1>
                </c:if>
                <h3 class="mb-5">변경할 이름을 입력하세요.</h3>
            </div>
            <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <form method="post" action="changeName">
                    <div class="form-row">
                        새로운 이름<input type="text" class="form-control form-control-lg" placeholder="새로운 이름 입력" name="newName"><br><br><br>

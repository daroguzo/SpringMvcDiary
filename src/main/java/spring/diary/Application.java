...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        spring.diary.dao.AccountDao accountDao = ctx.getBean("accountDao", spring.diary.dao.AccountDao.class);
        spring.diary.dao.DiaryDao diaryDao = ctx.getBean("diaryDao", spring.diary.dao.DiaryDao.class);
